...
<body>
	...
	<section>
	<form name="search">
			<h2 class="h_title">Rescue List</h2>
			<div id="searchForm">
		...
		<c:if test="${not empty id }">
			<div id="bottom">
				<a href="./view/rescue/RescueWrite.jsp" class="btn">글작성</a>
	...
	<div class="paging">
		...
		<div id="paging">
		<div> <!-- 이전 -->
			<a href="<%=ctxPath%>/rescueList.do?pageNum=<%=startPage%>"><button class="btn"><span>[이전]</span></button></a>
			<%
				} else {
			%>
		...
		<div> <!-- 다음 -->
			...
			%>
			<a href="<%=ctxPath%>/rescueList.do?pageNum=<%=endPage%>"><button class="btn"><span>[다음]</span></button></a>
			<%
					} else {
			%>
			<a href="<%=ctxPath%>/rescueList.do?pageNum=<%=currentPage + 1%>">
