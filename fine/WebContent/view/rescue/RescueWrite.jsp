	...
	<h2>QnA 작성하기</h2>
		...
		<table id="writeTable">
			...
			<tr>
				...
				<td><input type="file" class="btn" name="rec_img1" rows="10" multiple></td>
			</tr>
			<tr>
				<td class="td1">파일 첨부</td>
				<td><input type="file" class="btn" name="rec_img2" rows="10" multiple></td>
			</tr>
		</table>
		<input type="button" value="등록" id="btn" class="btn" onclick="doWrite()">
		<a href="<%=ctxPath %>/rescueList.do" id="btn" class="btn">목록보기</a>
	</form>
	<!-- FOOTER -->
