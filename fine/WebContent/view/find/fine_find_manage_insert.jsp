...
<body>
 	...
 	<form name="fineWriteFrm">
            ...
            <table>
                    ...
                    <tr>
                        <td>발견일</td>
                        <td><input type="text" name="happenDt" id="happenDt" size="12"></td>
                    </tr>
                    <tr>
                        <td>품종</td>
                        <td><select onchange="categoryChange(this)" style="width: 100px">
							...
							<select id="dog_kind" name="dogKind" style="width: 100px">
							</select><br></td>
                    </tr>
                    <tr>
                        <td>증성화 여부</td>
                        <td>
                        <select id="neuterYn" name="neuterYn">
                        	<option>Y</option>
                        	<option>N</option>
                        	<option>U</option>
                        </select>
                    ...
                    <tr>
                        <td>특이사항</td>
                        <td><input type="text" id="specialMark" name="specialMark"></td>
                    </tr>
                    <tr>
                        <td>몸무게</td>
