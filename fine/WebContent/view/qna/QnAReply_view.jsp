...
<body>
	...
	<form action="qnaReply.do" method="post">
		<input type="hidden" name="qna_no" value="${reply_view.qna_no}">
		...
		<table cellpadding="0" cellspacing="0" border="1">
			<tr>
				<td>글 번호</td>
				<td>${reply_view.qna_no}</td>
			</tr>
			<tr>
				<td>조회수</td>
				<td>${reply_view.qna_count }</td>
			</tr>
			<tr>
				<td>답변 제목</td>
				<td><input type="text" name="title"
					value="${reply_view.qna_title}" placeholder="[댓글 ]혹은 [답글] : 제목"></td>
			</tr>
			<tr>
				<td>답변 작성자</td>
			...
			<tr>
				<td>작성일</td>
				<td>${reply_view.qna_write_date }</td>
			</tr>
			<tr>
				<td>답변 내용</td>
				<td><textarea rows="10" name="content">${reply_view.qna_contents}</textarea></td>
			</tr>
			<tr>
				<td>비밀번호</td>
