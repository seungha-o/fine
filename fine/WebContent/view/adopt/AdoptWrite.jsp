...
<script type="text/javascript">
	function doWrite() {
		...
		form.action = "<%=ctxPath %>/adoptWrite.do";
		form.method = "post";
		form.submit();
	}
</script>
	...
	<form name="write" id="writeForm" encType="multipart/form-data">
		...
		<table id="writeTable">
			...
			<tr>
				...
				<td><input type="file"  class="btn"  name="adopt_img" rows="10" multiple></td>
			</tr>
			<tr>
				<td class="td1" >파일 첨부</td>
				<td><input type="file"   class="btn" name="adopt_img2" rows="10" multiple></td>
			</tr>
		</table>
		<input type="submit" value="등록" id="btn" class="btn"  onclick="doWrite()">
		<a href="<%=ctxPath %>/adoptList.do" id="btn" class="btn">목록보기</a>
	</form>
	<!-- FOOTER -->
