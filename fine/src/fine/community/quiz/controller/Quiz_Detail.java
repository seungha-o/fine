...
@WebServlet("/quizDetail.do")
public class Quiz_Detail extends HttpServlet {
...
protected void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher disp = request.getRequestDispatcher("./view/quiz/fine_quiz_Detail.jsp?no="+no);
